...
def calculate(df):
    ...
    result_df['Range Minimum'] = result_df['Target Pay'] * 0.8
    result_df['Range Maximum'] = result_df['Target Pay'] * 1.2
    ...
    result_df = result_df.drop_duplicates(subset='Grade').reset_index(drop=True)
